...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 17 - Manejo Archivos
# ================================================
# Script para ejecutar ejercicios de Manejo Archivos con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_17_manejo_archivos.py"
LOG_FILE="resultados_17_manejo_archivos.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 17 - MANEJO ARCHIVOS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 17 – MANEJO ARCHIVOS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Manejo Archivos...${NC}"
echo ""
...
echo -e "🧩 Sesión 17 – Manejo Archivos"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_17_manejo_archivos.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_17_manejo_archivos.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_17_manejo_archivos.md${NC}"
