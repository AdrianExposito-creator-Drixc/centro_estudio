...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 24 - Estadisticas
# ================================================
# Script para ejecutar ejercicios de Estadisticas con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_24_estadisticas.py"
LOG_FILE="resultados_24_estadisticas.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 24 - ESTADISTICAS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 24 – ESTADISTICAS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Estadisticas...${NC}"
echo ""
...
echo -e "🧩 Sesión 24 – Estadisticas"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_24_estadisticas.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_24_estadisticas.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_24_estadisticas.md${NC}"
