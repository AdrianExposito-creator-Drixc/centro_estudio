...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 01 - Hola Mundo
# ================================================
# Script para ejecutar ejercicios de Hola Mundo con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_01_hola_mundo.py"
LOG_FILE="resultados_01_hola_mundo.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 01 - HOLA MUNDO"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 01 – HOLA MUNDO" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Hola Mundo...${NC}"
echo ""
...
echo -e "🧩 Sesión 01 – Hola Mundo"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_01_hola_mundo.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_01_hola_mundo.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_01_hola_mundo.md${NC}"
