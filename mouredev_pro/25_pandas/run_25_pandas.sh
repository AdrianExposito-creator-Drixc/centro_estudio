...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 25 - Pandas
# ================================================
# Script para ejecutar ejercicios de Pandas con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_25_pandas.py"
LOG_FILE="resultados_25_pandas.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 25 - PANDAS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 25 – PANDAS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Pandas...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_25_pandas.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_25_pandas.md${NC}"
