...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 13 - List Comprehension
# ================================================
# Script para ejecutar ejercicios de List Comprehension con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_13_list_comprehension.py"
LOG_FILE="resultados_13_list_comprehension.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 13 - LIST COMPREHENSION"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 13 – LIST COMPREHENSION" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de List Comprehension...${NC}"
echo ""
...
echo -e "🧩 Sesión 13 – List Comprehension"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_13_list_comprehension.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_13_list_comprehension.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_13_list_comprehension.md${NC}"
