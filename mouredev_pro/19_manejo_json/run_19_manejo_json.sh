...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 19 - Manejo JSON
# ================================================
# Script para ejecutar ejercicios de Manejo JSON con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_19_manejo_json.py"
LOG_FILE="resultados_19_manejo_json.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 19 - MANEJO JSON"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 19 – MANEJO JSON" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Manejo JSON...${NC}"
echo ""
...
echo -e "🧩 Sesión 19 – Manejo JSON"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_19_manejo_json.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_19_manejo_json.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_19_manejo_json.md${NC}"
