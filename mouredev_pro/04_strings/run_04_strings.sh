...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 04 - Strings
# ================================================
# Script para ejecutar ejercicios de Strings con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_04_strings.py"
LOG_FILE="resultados_04_strings.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 04 - STRINGS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 04 – STRINGS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Strings...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_04_strings.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_04_strings.md${NC}"
