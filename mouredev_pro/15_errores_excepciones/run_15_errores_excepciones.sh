...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 15 - Errores Excepciones
# ================================================
# Script para ejecutar ejercicios de Errores Excepciones con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_15_errores_excepciones.py"
LOG_FILE="resultados_15_errores_excepciones.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 15 - ERRORES EXCEPCIONES"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 15 – ERRORES EXCEPCIONES" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Errores Excepciones...${NC}"
echo ""
...
echo -e "🧩 Sesión 15 – Errores Excepciones"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_15_errores_excepciones.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_15_errores_excepciones.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_15_errores_excepciones.md${NC}"
