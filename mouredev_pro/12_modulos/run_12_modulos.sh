...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 12 - Modulos
# ================================================
# Script para ejecutar ejercicios de Modulos con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_12_modulos.py"
LOG_FILE="resultados_12_modulos.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 12 - MODULOS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 12 – MODULOS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Modulos...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_12_modulos.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_12_modulos.md${NC}"
