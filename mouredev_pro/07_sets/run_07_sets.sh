...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 07 - Sets
# ================================================
# Script para ejecutar ejercicios de Sets con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_07_sets.py"
LOG_FILE="resultados_07_sets.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 07 - SETS"
echo -e "================================================${NC}"
...
echo -e "${PURPLE}🚀 Ejecutando script de Sets...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_07_sets.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_07_sets.md${NC}"
