...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 18 - Expresiones Regulares
# ================================================
# Script para ejecutar ejercicios de Expresiones Regulares con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_18_expresiones_regulares.py"
LOG_FILE="resultados_18_expresiones_regulares.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 18 - EXPRESIONES REGULARES"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 18 – EXPRESIONES REGULARES" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Expresiones Regulares...${NC}"
echo ""
...
echo -e "🧩 Sesión 18 – Expresiones Regulares"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_18_expresiones_regulares.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_18_expresiones_regulares.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_18_expresiones_regulares.md${NC}"
