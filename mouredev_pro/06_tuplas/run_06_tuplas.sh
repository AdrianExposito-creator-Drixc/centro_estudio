...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 06 - Tuplas
# ================================================
# Script para ejecutar ejercicios de Tuplas con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_06_tuplas.py"
LOG_FILE="resultados_06_tuplas.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 06 - TUPLAS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 06 – TUPLAS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Tuplas...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_06_tuplas.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_06_tuplas.md${NC}"
