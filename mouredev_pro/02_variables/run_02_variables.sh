...
LOG_FILE="resultados_02_variables.log"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 02 – VARIABLES" >> "$LOG_FILE"
...
echo -e "🧩 Sesión 02 – Variables"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_02_variables.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_02_variables.md${NC}"
