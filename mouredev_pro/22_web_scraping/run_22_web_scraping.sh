...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 22 - Web Scraping
# ================================================
# Script para ejecutar ejercicios de Web Scraping con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_22_web_scraping.py"
LOG_FILE="resultados_22_web_scraping.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 22 - WEB SCRAPING"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 22 – WEB SCRAPING" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Web Scraping...${NC}"
echo ""
...
echo -e "🧩 Sesión 22 – Web Scraping"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_22_web_scraping.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_22_web_scraping.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_22_web_scraping.md${NC}"
