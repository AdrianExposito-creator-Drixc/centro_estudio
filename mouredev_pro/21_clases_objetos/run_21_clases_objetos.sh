...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 21 - Clases Objetos
# ================================================
# Script para ejecutar ejercicios de Clases Objetos con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_21_clases_objetos.py"
LOG_FILE="resultados_21_clases_objetos.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 21 - CLASES OBJETOS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 21 – CLASES OBJETOS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Clases Objetos...${NC}"
echo ""
...
echo -e "🧩 Sesión 21 – Clases Objetos"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_21_clases_objetos.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_21_clases_objetos.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_21_clases_objetos.md${NC}"
