...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 26 - Python Web
# ================================================
# Script para ejecutar ejercicios de Python Web con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_26_python_web.py"
LOG_FILE="resultados_26_python_web.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 26 - PYTHON WEB"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 26 – PYTHON WEB" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Python Web...${NC}"
echo ""
...
echo -e "🧩 Sesión 26 – Python Web"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_26_python_web.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_26_python_web.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_26_python_web.md${NC}"
