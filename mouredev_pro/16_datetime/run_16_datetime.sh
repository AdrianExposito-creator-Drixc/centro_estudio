...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 16 - Datetime
# ================================================
# Script para ejecutar ejercicios de Datetime con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_16_datetime.py"
LOG_FILE="resultados_16_datetime.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 16 - DATETIME"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 16 – DATETIME" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Datetime...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_16_datetime.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_16_datetime.md${NC}"
