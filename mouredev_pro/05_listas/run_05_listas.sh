...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 05 - Listas
# ================================================
# Script para ejecutar ejercicios de Listas con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_05_listas.py"
LOG_FILE="resultados_05_listas.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 05 - LISTAS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 05 – LISTAS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Listas...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_05_listas.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_05_listas.md${NC}"
