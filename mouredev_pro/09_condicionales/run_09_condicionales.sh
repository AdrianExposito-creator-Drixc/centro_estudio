...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 09 - Condicionales
# ================================================
# Script para ejecutar ejercicios de Condicionales con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_09_condicionales.py"
LOG_FILE="resultados_09_condicionales.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 09 - CONDICIONALES"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 09 – CONDICIONALES" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Condicionales...${NC}"
echo ""
...
echo -e "🧩 Sesión 09 – Condicionales"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_09_condicionales.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_09_condicionales.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_09_condicionales.md${NC}"
