...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 20 - PIP
# ================================================
# Script para ejecutar ejercicios de PIP con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_20_pip.py"
LOG_FILE="resultados_20_pip.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 20 - PIP"
echo -e "================================================${NC}"
...
echo -e "${PURPLE}🚀 Ejecutando script de PIP...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_20_pip.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_20_pip.md${NC}"
