...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 08 - Diccionarios
# ================================================
# Script para ejecutar ejercicios de Diccionarios con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_08_diccionarios.py"
LOG_FILE="resultados_08_diccionarios.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 08 - DICCIONARIOS"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 08 – DICCIONARIOS" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Diccionarios...${NC}"
echo ""
...
echo -e "🧩 Sesión 08 – Diccionarios"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_08_diccionarios.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_08_diccionarios.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_08_diccionarios.md${NC}"
