...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 03 - Operadores
# ================================================
# Script para ejecutar ejercicios de Operadores con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_03_operadores.py"
LOG_FILE="resultados_03_operadores.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 03 - OPERADORES"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 03 – OPERADORES" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Operadores...${NC}"
echo ""
...
echo -e "🧩 Sesión 03 – Operadores"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_03_operadores.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_03_operadores.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_03_operadores.md${NC}"
