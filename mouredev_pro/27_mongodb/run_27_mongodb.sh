...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 27 - MongoDB
# ================================================
# Script para ejecutar ejercicios de MongoDB con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_27_mongodb.py"
LOG_FILE="resultados_27_mongodb.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 27 - MONGODB"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 27 – MONGODB" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de MongoDB...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_27_mongodb.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_27_mongodb.md${NC}"
