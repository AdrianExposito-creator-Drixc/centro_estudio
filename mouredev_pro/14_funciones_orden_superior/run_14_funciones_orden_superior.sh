...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 14 - Funciones Orden Superior
# ================================================
# Script para ejecutar ejercicios de Funciones Orden Superior con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_14_funciones_orden_superior.py"
LOG_FILE="resultados_14_funciones_orden_superior.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 14 - FUNCIONES ORDEN SUPERIOR"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 14 – FUNCIONES ORDEN SUPERIOR" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Funciones Orden Superior...${NC}"
echo ""
...
echo -e "🧩 Sesión 14 – Funciones Orden Superior"
echo -e "📅 Fecha: $(date +"%d/%m/%Y")"
echo -e "📍 Archivo: $SCRIPT_NAME"
if [ $EXIT_CODE -eq 0 ]; then
    echo -e "✅ Estado: Ejecutado correctamente"
    echo -e "🧠 Conceptos reforzados: [Revisar en notas_14_funciones_orden_superior.md]"
else
...
echo -e "• Ver notas: ${CYAN}code notas_14_funciones_orden_superior.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_14_funciones_orden_superior.md${NC}"
