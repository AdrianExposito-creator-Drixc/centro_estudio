...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 28 - API
# ================================================
# Script para ejecutar ejercicios de API con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_28_api.py"
LOG_FILE="resultados_28_api.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 28 - API"
echo -e "================================================${NC}"
...
echo -e "${PURPLE}🚀 Ejecutando script de API...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_28_api.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_28_api.md${NC}"
