...
# ================================================
# 🚀 EJECUTOR AUTOMÁTICO SESIÓN 10 - Bucles
# ================================================
# Script para ejecutar ejercicios de Bucles con logging automático
...
SESION_DIR="$(pwd)"
SCRIPT_NAME="ejercicios_sesion_10_bucles.py"
LOG_FILE="resultados_10_bucles.log"
FECHA=$(date +"%d/%m/%Y %H:%M:%S")

echo -e "${CYAN}================================================"
echo -e "🐍 EJECUTOR SESIÓN 10 - BUCLES"
echo -e "================================================${NC}"
...
echo "================================================" > "$LOG_FILE"
echo "🧩 SESIÓN 10 – BUCLES" >> "$LOG_FILE"
...
echo -e "${PURPLE}🚀 Ejecutando script de Bucles...${NC}"
echo ""
...
echo -e "• Ver notas: ${CYAN}code notas_10_bucles.md${NC}"

echo ""
echo -e "${GREEN}🎯 Siguiente paso: Revisar conceptos en notas_10_bucles.md${NC}"
